...
const MCPOperacionesCombinadosExercises: React.FC = () => {
  ...
  useEffect(() => {
    const fetchExercises = async () => {
      try {
        setLoading(true);
        const response = await apiService.getExercisesByIds(['MAT-1', 'MAT-2']);
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Cargando ejercicios combinados...</p>
        </div>
      </div>
    );
  }
  ...
  if (exercises.length === 0) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <p className="text-gray-600 dark:text-gray-400">No se encontraron ejercicios combinados.</p>
          <Link to="/matematicas" className="text-primary hover:text-primary/80 mt-4 inline-block">
      ...
      <div className="p-8 max-w-4xl mx-auto">
        <div className="text-center bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">Has terminado todos los ejercicios combinados.</p>
          </div>
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <Link to="/matematicas" className="inline-flex items-center text-primary hover:text-primary/80 mb-4">
          <span className="material-symbols-outlined mr-2">arrow_back</span>
          Volver a Matemáticas
        </Link>
        
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Ejercicios Combinados</h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
        ...
        <div className="flex justify-between">
          <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
            <div className="text-base">Operaciones Combinadas</div>
          </div>
...
export default MCPOperacionesCombinadosExercises;
